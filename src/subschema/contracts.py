"""
Stable contracts shared by the prover.
"""
...
UnsupportedDisposition = Literal["deferable", "non_terminal", "terminal"]
...
class UnsupportedDiagnostic:
    ...
    disposition: UnsupportedDisposition = "terminal"
...
class ProofResult:
    ...
    def __repr__(self) -> str:
        ...
        if self.unsupported_priority:
            parts.append(f"unsupported_priority={self.unsupported_priority}")
