...
def right_not_string_overlap_plan_from_constraints(
    ...
    negated_shape = negated_constraint.shape
    ...
    if string_length_fragments_are_disjoint(lhs_schema, negated_schema):
    ...
    witness = string_language_witness(overlap, context)
