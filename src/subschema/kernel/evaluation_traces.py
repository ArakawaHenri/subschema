"""
Evaluation trace resolution for reference and branch-aware unevaluated* proofs.
"""
...
def _conditional_expression(
    ...
    *,
    ...
    disjoint = schemas_are_disjoint(lhs_schema, if_schema, context)
...
def _evaluation_expression_cache_key(
    source: Any, lhs_schema: Any, context: EvaluationTraceContext
) -> tuple[Any, ...]:
    return (
        source.resource_uri,
